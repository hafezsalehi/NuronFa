  ...
  var imJs = {
    ...
    slickActivation: function () {
      $(".slick-activation-01").slick({
        ...
        adaptiveHeight: true,
        prevArrow:
          '<button class="slide-arrow prev-arrow"><i class="feather-arrow-right"></i></button>',
        nextArrow:
          '<button class="slide-arrow next-arrow"><i class="feather-arrow-left"></i></button>',
        responsive: [
          {
            breakpoint: 1124,
            settings: {
          ...
          success: function (data) {
            ...
            if (data.code === false) {
              ...
              _self
                .find(".rn-btn")
                .after(
                  '<div class="error-msg bg-danger text-white rounded-3 mt-4 p-3"><p class="small text-white">*' +
                    data.err +
                    "</p></div>"
                );
              console.log(data);
              ...
              _self
                .find(".rn-btn")
                .after(
                  '<div class="success-msg bg-success rounded-3 mt-4 p-3"><p class="small text-white">' +
                    data.success +
                    "</p></div>"
                );
    ...
    filterClickButton: function () {
      ...
      $("#slider-range").slider({
        ...
        slide: function (event, ui) {
          $("#amount").val(
            ui.values[0] + " هزارتومان - " + ui.values[1] + " هزارتومان "
          );
        },
      });
      $("#amount").val(
